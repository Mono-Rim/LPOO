...
public class ProdutoController {
    public static void main(String[] args) {
        ...
        produtosMap.put(String.valueOf(produto1.getId()), produto1);
        produtosMap.put(String.valueOf(produto2.getId()), produto2);
        produtosMap.put(String.valueOf(produto3.getId()), produto3);
        produtosMap.put(String.valueOf(produto4.getId()), produto4);
        produtosMap.put(String.valueOf(produto5.getId()), produto5);


        System.out.println(produtosMap.get(String.valueOf(produto3.getId())));
